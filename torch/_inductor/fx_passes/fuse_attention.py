...
def _sfdp_pattern_21_(query, key, value, attn_mask, do_view):
...
def _sfdp_pattern_21_v1(query, key, value, attn_mask):
    return _sfdp_pattern_21_(query, key, value, attn_mask, do_view=True)

def _sfdp_pattern_21_v2(query, key, value, attn_mask):
    return _sfdp_pattern_21_(query, key, value, attn_mask, do_view=False)
...
def _sfdp_pattern_22_(query, key, value, attn_mask, do_view):
...
def _sfdp_pattern_22_v1(query, key, value, attn_mask):
    return _sfdp_pattern_22_(query, key, value, attn_mask, do_view=True)

def _sfdp_pattern_22_v2(query, key, value, attn_mask):
    return _sfdp_pattern_22_(query, key, value, attn_mask, do_view=False)
...
def _sfdp_pattern_23_(query, key, value, do_view):
...
def _sfdp_pattern_23_v1(query, key, value):
    return _sfdp_pattern_23_(query, key, value, do_view=True)

def _sfdp_pattern_23_v2(query, key, value):
    return _sfdp_pattern_23_(query, key, value, do_view=False)
