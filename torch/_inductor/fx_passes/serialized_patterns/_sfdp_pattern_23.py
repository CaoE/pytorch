...
bmm_default_1 = CallFunction(aten.bmm.default, view_default_3, view_default_4)
_sfdp_pattern_23_inference = CallFunction(aten.view.default, bmm_default_1, Ignored(), _users=0)
...
view_default_4 = CallFunction(aten.view.default, clone_default_2, Ignored())
bmm_default_1 = CallFunction(aten.bmm.default, view_default_3, view_default_4)
_sfdp_pattern_23_half_inference = CallFunction(aten.view.default, bmm_default_1, Ignored(), _users=0)
